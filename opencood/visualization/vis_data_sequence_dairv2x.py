...
if __name__ == '__main__':
    ...
    # opencood/hypes_yaml/dairv2x/visualization_dair.yaml
    hypes = load_yaml(os.path.join(current_path,
                                    '../hypes_yaml/dairv2x/visualization_dair.yaml'))
    output_path = "/home/caoyitong/PycharmProjects/CoAlign/data_vis_dariv2x"
    ...
    subset_idx = range(0, 100)
    subset_dataset = Subset(opencda_dataset, subset_idx)
    
    data_loader = DataLoader(subset_dataset, batch_size=1, num_workers=2,
    ...
    for i, batch_data in enumerate(data_loader):
        ...
        simple_vis.visualize({"gt_box_tensor": gt_box_tensor},
